...
for i in tqdm(range(n_trials)):
    B, B_hat_list, M_k_B_list = run_MLR_trial(p, L, n, alpha, B_cov, sigma_sq, n_iters, RNG)
    mse[i, :len(B_hat_list), :] = np.array([B_loss(B, B_hat, True) for B_hat in B_hat_list])
